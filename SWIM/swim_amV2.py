...
class Chat():
    ...
    def updateChat(self,role,content,llm=None,tokenCount=0):
        ...
        if llm!=None and tokenCount > llm.maxContext:
            ...
            if des=='y':
                tokenCount=self.condenseHistory(llm)
                role='user'
...
objective7='''Here the primary system objective is to keep the average response time as low as possible. Secondary objective is to keep dimmer as high as possible. Tertiary objective is to keep servers used as less as possible. These objectives are given in decreasing order of priority.'''
